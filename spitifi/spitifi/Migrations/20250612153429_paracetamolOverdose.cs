...
{
    /// <inheritdoc />
    public partial class paracetamolOverdose : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Album_Utilizadores_DonoFK",
                        column: x => x.DonoFK,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nome = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AlbumFK = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MusicaFK = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "admin", 0, "4f58a2a5-5148-48f6-bc1c-74cae86a2172", "admin@mail.pt", true, false, null, "ADMIN@MAIL.PT", "ADMIN@MAIL.PT", "AQAAAAIAAYagAAAAEFlD4rWdfnejmxUQKtzTOPTmPam7Yu/J72fGU+oiFQTk2TgMCMRBNFng7zZ2SF0xpA==", null, false, "29c12eb3-07f7-4cd8-a5d2-ab4e40e6d064", false, "admin@mail.pt" },
                    { "jonas", 0, "9f58a2a5-5148-48f6-bc1c-74cae86a2172", "jonas@mail.pt", true, false, null, "JONAS@MAIL.PT", "JONAS@MAIL.PT", "AQAAAAIAAYagAAAAEFKLw0uBBh9txvVxKuA+BqRA+fJNCa7MkdBTAnk7uj5/ZB/NyYA1N5befK1jj2FjnQ==", null, false, "99c12eb3-07f7-4cd8-a5d2-ab4e40e6d064", false, "jonas@mail.pt" }
                });
